...
## Project Structure
    ...
    ├── testapiautoconnect_109386  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_109386`
...
2. Clone this repo and `cd testapiautoconnect_109386`
